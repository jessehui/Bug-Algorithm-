...
sim-outorder -cache:dl1 dl2:2048:64:4:l -dumpconfig new_cfg
sim-outorder -config new_cfg eeg 2>&1 | grep -e "sim_IPC" -e "sim_CPI" -e "avg_total_power_cycle_cc3" | tee -a res2.txt
echo -e "\n" >> re2.txt


echo "dl2:512:64:4:l" >> res2.txt
sim-outorder -cache:dl1 dl2:512:64:4:l -dumpconfig new_cfg
sim-outorder -config new_cfg eeg 2>&1 | grep -e "sim_IPC" -e "sim_CPI" -e "avg_total_power_cycle_cc3" | tee -a res2.txt
echo -e "\n" >> re2.txt


echo "dl2:1024:16:4:l" >> res2.txt
sim-outorder -cache:dl1 dl2:1024:16:4:l -dumpconfig new_cfg
sim-outorder -config new_cfg eeg 2>&1 | grep -e "sim_IPC" -e "sim_CPI" -e "avg_total_power_cycle_cc3" | tee -a res2.txt
echo -e "\n" >> re2.txt


echo "dl2:1024:256:4:l" >> res2.txt
sim-outorder -cache:dl1 dl2:1024:256:4:l -dumpconfig new_cfg
sim-outorder -config new_cfg eeg 2>&1 | grep -e "sim_IPC" -e "sim_CPI" -e "avg_total_power_cycle_cc3" | tee -a res2.txt
echo -e "\n" >> re2.txt
